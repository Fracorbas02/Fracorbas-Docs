...
- **USER** : identifie l'utilisateur
- **PASS** : mot de passe
- **STAT** : nombre de messages et taille totale
- **LIST** : liste tous les messages avec leur taille
- **RETR** : récupère le message n
- **DELE** : marque le message n pour suppression
...
- **SELECT** : sélectionne le dossier (ex : inbox)
- **FETCH** : récupère le message n (header + body)
- **MOVE** : déplace des messages vers un autre dossier
- **COPY** : copie des messages
- **LOGOUT** : déconnexion
